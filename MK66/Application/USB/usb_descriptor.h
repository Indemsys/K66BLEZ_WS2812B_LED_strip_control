...
/* Here Other speed Configuration is for FULL SPEED */
    #define OTHER_SPEED_DIC_BULK_IN_ENDP_PACKET_SIZE     (512)/* max supported is 64 for FS and 512 for HS*/
    #define OTHER_SPEED_DIC_BULK_OUT_ENDP_PACKET_SIZE    (512)/* max supported is 64 and 512 for HS*/
  #endif
